                ...
                <thead>
                    <tr bgcolor="#a9a9a9">
                        ...
                        <td>
                            ...
                            <label for="aimDescending"><img src="https://img.icons8.com/officexs/16/000000/sort-down.png"/></label>
                            <input id="aimAscending" type="radio" name="sort" value="aimAscending">
                            <label for="aimAscending"><img src="https://img.icons8.com/officexs/16/000000/sort-up.png"/></label>
                            <br>
                        ...
                        <td>
                            ...
                            <label for="statusDescending"><img src="https://img.icons8.com/officexs/16/000000/sort-down.png"/></label>
                            <input id="statusAscending" type="radio" name="sort" value="statusAscending">
                            <label for="statusAscending"><img src="https://img.icons8.com/officexs/16/000000/sort-up.png"/></label>
                            <br>
